...
public class ResourceManager implements Closeable {
	...
	/**
	 * Get the texture with the specified fileName
	 * The texture will be synchronously loaded if it
	 * wasn't before
	 * @param fileName
	 * @return
	 */
	public Texture getTexture(String fileName) {
		Texture texture = this.<Texture>tryGet(fileName);
		
		if (texture == null) {
			this.load(Texture.class, fileName);
